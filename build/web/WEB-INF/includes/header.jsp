...
<header class="main-header">
    <div class="je-container">
        <div class="je-item container-logo"><a class="logo" href="/"><img src="imgs/svg/logo.svg" alt="logo de la página"></a></div>
                    ...
                    <li>
                        <div class="container-perfil">
                            ...
                            <a class="logo" href="perfil?id=<%=us.getIdPerson()%>">
                                <img src="imgs/jpg/yop.jpg" alt="perfil" style="height:2rem;">
                               </a>
                               <svg class="icon-flecha" viewBox="0 0 284.929 284.929" class="svg-icon icon-arrow" id="user-arrow" xmlns="http://www.w3.org/2000/svg">
                                  ...
                                  <div class="user-acces">
                                      <a href="Perfil" class="button ghost">Perfil</a>
