...
<html lang="es">
    <head>
        ...
        <meta name="description" content="Perfil del usuario <%=us.getUsername()%>">
        ...
        <link rel="stylesheet" href="css/pages/perfil/edit.css">
        <script src="js/toogle.js"></script>
        <script src="js/form.js"></script>
    </head>
    <body>
        <jsp:include page="../includes/header.jsp"></jsp:include>
        <div class="user-banner-portada">
            <img src="imgs/jpg/banner.jpg" alt="imagen de portada">
        </div>
        <main>
                ...
                <div class="je-item main-edit">
                    <form method="post" name="form-editar-perfil" action="perfil">
                        ...
                        <div class="form-item descripcion-profile">
                            ...
                            <span class="count-desc circle" id="count-desc">0</span>
                        </div>
                        <!--<div class="form-item">
                            ...
                            <select name="contry">
                                ...
                                <option value="perú"> Arequipa</option>
                            </select>
