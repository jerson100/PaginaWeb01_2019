    ...
    <main>
      ...
      <div class="je-container main">
        <section class="je-item section-user">
          ...
          <div class="user-dat user-img"><img src="imgs/jpg/yop.jpg" alt="Yo"></div>
          <p class="t3 grey-color-dark color">Jerson Ramírez Ortiz2</p>
          <div class="user-dat user-email">
            <p>juamkoo@gmail.com</p>
          </div>
          <div class="user-dat user-description">
            <p class="small">Me gusta mucho la programación Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quas saepe animi aut quisquam reiciendis dolores illum recusandae veniam ducimus, voluptate facilis consequuntur minus. Enim officiis sed est, magni assumenda voluptas!</p>
          </div>
          <div class="user-dat user-country">
            <p class="small"> <span>P <span>Hural, Perú</span></span></p>
          </div>
          <div class="user-dat user-social">
            <div class="user-social_web"><a class="smaller" href=""><span><a href="#">jersonramirez.epizy.com</a></span></a></div>
            <div class="user-red-social"><span>F G</span></div>
          </div>
          <button class="user-dat button ghost">cambiar contraseña</button>
          <button class="user-dat button">Editar</button>
          ...
          <div class="container-publicaciones">
            <div class="group-post">
              <div class="container-card">
                <article class="card_article">
                  <header class="card_header">
                    <h3 class="card_title t4"><a href="html/ejercicios_basicos/ejercicio1.html">Title ♥♥</a></h3><img class="card-img-post" src="imgs/jpg/h.jpg" alt="Hallar la suma de n números"/>
                    <div class="like-post"><span>1</span><svg viewBox="0 0 17 15.736" class="svg-like" xmlns="http://www.w3.org/2000/svg"> <path d="M0,40.045H2.909V31.318H0Zm16-8a1.459,1.459,0,0,0-1.455-1.455H9.964l.727-3.345v-.218a1.525,1.525,0,0,0-.291-.8L9.6,25.5,4.8,30.3a1.22,1.22,0,0,0-.436,1.018v7.273a1.459,1.459,0,0,0,1.455,1.455h6.545a1.437,1.437,0,0,0,1.309-.873l2.182-5.164a1.238,1.238,0,0,0,.073-.509V32.045H16Z" transform="translate(0.5 -24.81)"></path> </svg></div>
                  </header>
                  <footer class="card_footer">
                    <div class="je-container card_footer_container">
                      <div class="card_footer_autor">
                        <div class="card-user">
                          <div class="card-user-type"><svg viewBox="0 0 16 16" class="svg-icon-admin" xmlns="http://www.w3.org/2000/svg"><g transform="translate(-97.103 -44.137)"><path d="M113.1,52.137a8,8,0,1,0-8,8,8,8,0,0,0,8-8" fill="#f0c419"></path><path d="M155.4,88.276l1.7,3.434,3.63.566-2.578,2.673.8,3.549L155.4,96.951,151.847,98.5l.8-3.549-2.578-2.673,3.63-.566Z" transform="translate(-50.299 -41.917)" fill="#ffe69f"></path></g></svg><span class="user-type_name">adm</span></div><img class="card_autor_img" src="imgs/jpg/yop.jpg" alt="Jerson Ramírez"/>
                        </div><a class="card_autor_name underline small" href="html/jerson.html">    Jerson Ramírez</a>
                      </div>
                      <div class="card_footer_fecha"><span class="small">24/09/2018 </span></div>
                    </div>
                  </footer>
                </article>
              </div>
              <div class="container-card">
                <article class="card_article">
                  <header class="card_header">
                    <h3 class="card_title t4"><a href="html/ejercicios_basicos/ejercicio1.html">Title ♥♥</a></h3><img class="card-img-post" src="imgs/jpg/i.jpg" alt="Hallar la suma de n números"/>
                    <div class="like-post"><span>1</span><svg viewBox="0 0 17 15.736" class="svg-like" xmlns="http://www.w3.org/2000/svg"> <path d="M0,40.045H2.909V31.318H0Zm16-8a1.459,1.459,0,0,0-1.455-1.455H9.964l.727-3.345v-.218a1.525,1.525,0,0,0-.291-.8L9.6,25.5,4.8,30.3a1.22,1.22,0,0,0-.436,1.018v7.273a1.459,1.459,0,0,0,1.455,1.455h6.545a1.437,1.437,0,0,0,1.309-.873l2.182-5.164a1.238,1.238,0,0,0,.073-.509V32.045H16Z" transform="translate(0.5 -24.81)"></path> </svg></div>
                  </header>
                  <footer class="card_footer">
                    <div class="je-container card_footer_container">
              ...
              <div class="container-card">
                <article class="card_article">
                  <header class="card_header">
                    <h3 class="card_title t4"><a href="html/ejercicios_basicos/ejercicio1.html">Title ♥♥</a></h3><img class="card-img-post" src="imgs/jpg/c.jpg" alt="Hallar la suma de n números"/>
                    <div class="like-post"><span>1</span><svg viewBox="0 0 17 15.736" class="svg-like" xmlns="http://www.w3.org/2000/svg"> <path d="M0,40.045H2.909V31.318H0Zm16-8a1.459,1.459,0,0,0-1.455-1.455H9.964l.727-3.345v-.218a1.525,1.525,0,0,0-.291-.8L9.6,25.5,4.8,30.3a1.22,1.22,0,0,0-.436,1.018v7.273a1.459,1.459,0,0,0,1.455,1.455h6.545a1.437,1.437,0,0,0,1.309-.873l2.182-5.164a1.238,1.238,0,0,0,.073-.509V32.045H16Z" transform="translate(0.5 -24.81)"></path> </svg></div>
                  </header>
                  <footer class="card_footer">
                    <div class="je-container card_footer_container">
            ...
            <div class="group-post">
              <div class="container-card">
                <article class="card_article">
                  <header class="card_header">
                    <h3 class="card_title t4"><a href="html/ejercicios_basicos/ejercicio1.html">Title ♥♥</a></h3><img class="card-img-post" src="imgs/jpg/d.jpg" alt="Hallar la suma de n números"/>
                    <div class="like-post"><span>1</span><svg viewBox="0 0 17 15.736" class="svg-like" xmlns="http://www.w3.org/2000/svg"> <path d="M0,40.045H2.909V31.318H0Zm16-8a1.459,1.459,0,0,0-1.455-1.455H9.964l.727-3.345v-.218a1.525,1.525,0,0,0-.291-.8L9.6,25.5,4.8,30.3a1.22,1.22,0,0,0-.436,1.018v7.273a1.459,1.459,0,0,0,1.455,1.455h6.545a1.437,1.437,0,0,0,1.309-.873l2.182-5.164a1.238,1.238,0,0,0,.073-.509V32.045H16Z" transform="translate(0.5 -24.81)"></path> </svg></div>
                  </header>
                  <footer class="card_footer">
                    <div class="je-container card_footer_container">
              ...
              <div class="container-card">
                <article class="card_article">
                  <header class="card_header">
                    <h3 class="card_title t4"><a href="/html/ejercicios_basicos/ejercicio1.html">Title ♥♥</a></h3><img class="card-img-post" src="imgs/jpg/g.jpg" alt="Hallar la suma de n números"/>
                    <div class="like-post"><span>1</span><svg viewBox="0 0 17 15.736" class="svg-like" xmlns="http://www.w3.org/2000/svg"> <path d="M0,40.045H2.909V31.318H0Zm16-8a1.459,1.459,0,0,0-1.455-1.455H9.964l.727-3.345v-.218a1.525,1.525,0,0,0-.291-.8L9.6,25.5,4.8,30.3a1.22,1.22,0,0,0-.436,1.018v7.273a1.459,1.459,0,0,0,1.455,1.455h6.545a1.437,1.437,0,0,0,1.309-.873l2.182-5.164a1.238,1.238,0,0,0,.073-.509V32.045H16Z" transform="translate(0.5 -24.81)"></path> </svg></div>
                  </header>
                  <footer class="card_footer">
                    <div class="je-container card_footer_container">
              ...
              <div class="group-date"><span class="small">2019</span><span class="small">27/08</span></div>
            </div>
            <div class="group-post">
              <div class="container-card">
                <article class="card_article">
                  <header class="card_header">
                    <h3 class="card_title t4"><a href="html/ejercicios_basicos/ejercicio1.html">Title ♥♥</a></h3><img class="card-img-post" src="imgs/jpg/a.jpg" alt="Hallar la suma de n números"/>
                    <div class="like-post"><span>1</span><svg viewBox="0 0 17 15.736" class="svg-like" xmlns="http://www.w3.org/2000/svg"> <path d="M0,40.045H2.909V31.318H0Zm16-8a1.459,1.459,0,0,0-1.455-1.455H9.964l.727-3.345v-.218a1.525,1.525,0,0,0-.291-.8L9.6,25.5,4.8,30.3a1.22,1.22,0,0,0-.436,1.018v7.273a1.459,1.459,0,0,0,1.455,1.455h6.545a1.437,1.437,0,0,0,1.309-.873l2.182-5.164a1.238,1.238,0,0,0,.073-.509V32.045H16Z" transform="translate(0.5 -24.81)"></path> </svg></div>
                  </header>
                  <footer class="card_footer">
                    <div class="je-container card_footer_container">
              ...
              <div class="group-date"><span class="small">2019</span><span class="small">20/08</span></div>
            </div>
          </div>
        </section>
      </div>
...
<text dy="0" dominant-baseline="auto" alignment-baseline="auto" font-family="Roboto Slab" font-size="18px" fill="#fff" letter-spacing="1" data-font-family="Roboto Slab" data-font-weight="bold" data-font-style="normal" font-weight="bold" font-style="normal" data-ttf-url="/builder_assets/fontsttf/font-open-sans-normal-normal.ttf" data-part-id="logo__item--tagline_3__0" data-font-filename="roboto-slab-bold-normal">FIISI</text>
    ...
    <script>
      ...
      body.innerHTML = `
          <form action='procesar' method='post' name='formulario-post'>
              <div class="form-item">
                  <label for="título">Título:</label>
                  <input type="text" id="título" name="titulo">
              </div>
              <div class="form-item">
      ...
      openModalAbstract('publicar',header,body,footer);    
    </script>
